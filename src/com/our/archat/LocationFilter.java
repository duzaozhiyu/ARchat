...
import com.our.archat.location.LocationService;
import com.our.archat.location.Utils;
...
/***
 * 定位滤波demo，实际定位场景中，可能会存在很多的位置抖动，此示例展示了�?种对定位结果进行的平滑优化处�?
 * 实际测试下，该平滑策略在市区步行场景下，有明显平滑效果，有效减少了部分抖动，�?放算法�?�辑，希望能够对�?发�?�提供帮�?
 * 注意：该示例场景仅用于对定位结果优化处理的演示，里边相关的策略或算法并不�?定�?�用于您的使用场景，请注意！！！
 * 
 * @author baidu
 * 
 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		reset.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(LocationFilter.this, FindContent.class);
		...
		public void handleMessage(Message msg) {
			...
			try {
				...
				if (location != null) {
					...
					if (iscal == 0) {
						bitmap = BitmapDescriptorFactory.fromResource(R.drawable.huaji); // 非推算结�?
					} else {
